  ...
  it('should accept user-entered locations', function () {
    var p = _mainPileup2['default'].create(testDiv, { 
      ...
      { 
        data: referenceSource, 
        viz: _mainPileup2['default'].viz.genome(), 
        isReference: true }] });var _getInputs4 = 




    getInputs('.controls input[type="text"]');var _getInputs42 = _slicedToArray(_getInputs4, 1);var locationTxt = _getInputs42[0];var _testDiv$querySelectorAll = 
