...
describe('VCF', function () {
  ...
  it('should have frequency', function () {
    ...
    return vcf.getFeaturesInRange(range).then(function (features) {
      ...
      (0, _chai.expect)(features[0].contig).to.equal('20');
      (0, _chai.expect)(features[0].majorFrequency).to.equal(0.7);
      (0, _chai.expect)(features[0].minorFrequency).to.equal(0.7);});});
  ...
  it('should have highest frequency', function () {
    ...
    return vcf.getFeaturesInRange(range).then(function (features) {
      (0, _chai.expect)(features).to.have.length(1);
      (0, _chai.expect)(features[0].contig).to.equal('20');
      (0, _chai.expect)(features[0].majorFrequency).to.equal(0.6);
      (0, _chai.expect)(features[0].minorFrequency).to.equal(0.3);});});
