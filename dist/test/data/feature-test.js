...
describe('Feature', function () {
  ...
  it('should parse features from GA4GH', function (done) {
    ...
    (0, _chai.expect)(features).to.have.length(9);
    (0, _chai.expect)(features[0].contig).to.equal("chr1");
    (0, _chai.expect)(features[0].start).to.equal(89295);
    (0, _chai.expect)(features[0].stop).to.equal(120932);
